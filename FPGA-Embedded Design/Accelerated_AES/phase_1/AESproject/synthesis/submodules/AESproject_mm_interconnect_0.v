...
module AESproject_mm_interconnect_0 (
	...
	wire    [8:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> aes_accelerator_0_avalon_master_agent:rp_channel
	...
	wire    [8:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> aes_accelerator_0_avalon_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire  [109:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> epcs_epcs_control_port_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // epcs_epcs_control_port_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> epcs_epcs_control_port_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> counter_0_control_slave_agent:cp_valid
	wire  [109:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> counter_0_control_slave_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // counter_0_control_slave_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> counter_0_control_slave_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> counter_0_control_slave_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> counter_0_control_slave_agent:cp_endofpacket
	...
	wire  [109:0] onchip_memory_s1_agent_rp_data;                                                     // onchip_memory_s1_agent:rp_data -> router_003:sink_data
	...
	wire          aes_accelerator_0_avalon_slave_agent_rp_valid;                                      // aes_accelerator_0_avalon_slave_agent:rp_valid -> router_004:sink_valid
	wire  [109:0] aes_accelerator_0_avalon_slave_agent_rp_data;                                       // aes_accelerator_0_avalon_slave_agent:rp_data -> router_004:sink_data
	wire          aes_accelerator_0_avalon_slave_agent_rp_ready;                                      // router_004:sink_ready -> aes_accelerator_0_avalon_slave_agent:rp_ready
	wire          aes_accelerator_0_avalon_slave_agent_rp_startofpacket;                              // aes_accelerator_0_avalon_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          aes_accelerator_0_avalon_slave_agent_rp_endofpacket;                                // aes_accelerator_0_avalon_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [109:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire          epcs_epcs_control_port_agent_rp_valid;                                              // epcs_epcs_control_port_agent:rp_valid -> router_006:sink_valid
	wire  [109:0] epcs_epcs_control_port_agent_rp_data;                                               // epcs_epcs_control_port_agent:rp_data -> router_006:sink_data
	wire          epcs_epcs_control_port_agent_rp_ready;                                              // router_006:sink_ready -> epcs_epcs_control_port_agent:rp_ready
	wire          epcs_epcs_control_port_agent_rp_startofpacket;                                      // epcs_epcs_control_port_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          epcs_epcs_control_port_agent_rp_endofpacket;                                        // epcs_epcs_control_port_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          counter_0_control_slave_agent_rp_valid;                                             // counter_0_control_slave_agent:rp_valid -> router_009:sink_valid
	wire  [109:0] counter_0_control_slave_agent_rp_data;                                              // counter_0_control_slave_agent:rp_data -> router_009:sink_data
	wire          counter_0_control_slave_agent_rp_ready;                                             // router_009:sink_ready -> counter_0_control_slave_agent:rp_ready
	wire          counter_0_control_slave_agent_rp_startofpacket;                                     // counter_0_control_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          counter_0_control_slave_agent_rp_endofpacket;                                       // counter_0_control_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire    [8:0] router_002_src_channel;                                                             // router_002:src_channel -> nios2_qsys_0_instruction_master_limiter:cmd_sink_channel
	...
	wire    [8:0] nios2_qsys_0_instruction_master_limiter_cmd_src_channel;                            // nios2_qsys_0_instruction_master_limiter:cmd_src_channel -> cmd_demux_002:sink_channel
	...
	wire    [8:0] rsp_mux_002_src_channel;                                                            // rsp_mux_002:src_channel -> nios2_qsys_0_instruction_master_limiter:rsp_sink_channel
	...
	wire    [8:0] nios2_qsys_0_instruction_master_limiter_cmd_valid_data;                             // nios2_qsys_0_instruction_master_limiter:cmd_src_valid -> cmd_demux_002:sink_valid
	...
	wire          counter_0_control_slave_agent_rdata_fifo_src_valid;                                 // counter_0_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] counter_0_control_slave_agent_rdata_fifo_src_data;                                  // counter_0_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          counter_0_control_slave_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_006:in_0_ready -> counter_0_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> counter_0_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> counter_0_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // counter_0_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> counter_0_control_slave_agent:rdata_fifo_sink_error
	...
	AESproject_mm_interconnect_0_router_001 router_001 (
	...
	AESproject_mm_interconnect_0_router_004 router_005 (
	...
	AESproject_mm_interconnect_0_router_004 router_006 (
	...
	AESproject_mm_interconnect_0_router_007 router_007 (
	...
	AESproject_mm_interconnect_0_router_007 router_008 (
	...
	AESproject_mm_interconnect_0_router_007 router_009 (
	...
	AESproject_mm_interconnect_0_router_007 router_010 (
	...
	AESproject_mm_interconnect_0_router_007 router_011 (
	...
	AESproject_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AESproject_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AESproject_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AESproject_mm_interconnect_0_cmd_mux_004 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AESproject_mm_interconnect_0_cmd_mux_004 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AESproject_mm_interconnect_0_cmd_mux_004 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AESproject_mm_interconnect_0_cmd_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	AESproject_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                            //       clk.clk
		.reset               (aes_accelerator_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
