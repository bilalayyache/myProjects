...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../AESproject.sopcinfo
...
# Design Name 
# setting SOPC_NAME is AESproject
SOPC_NAME := AESproject
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x220a0
SOPC_SYSID_FLAG += --sidp=0x220a0
ELF_PATCH_FLAG  += --sidp 0x220a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1583018912
SOPC_SYSID_FLAG += --timestamp=1583018912
ELF_PATCH_FLAG  += --timestamp 1583018912
