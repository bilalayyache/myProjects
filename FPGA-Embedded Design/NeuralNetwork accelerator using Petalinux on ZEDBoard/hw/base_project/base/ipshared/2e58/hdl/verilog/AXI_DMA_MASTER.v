...
reg   [0:0] icmp_ln58_reg_272;
wire    ap_CS_fsm_pp0_stage0;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0;
reg   [0:0] icmp_ln74_reg_242;
reg    out_stream_TDATA_blk_n;
wire    ap_CS_fsm_state9;
reg    ap_enable_reg_pp1_iter2;
reg   [0:0] icmp_ln58_reg_272_pp1_iter1_reg;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln74_reg_242_pp0_iter1_reg;
reg   [31:0] i1_0_reg_80;
reg   [31:0] i_0_reg_91;
...
wire   [0:0] icmp_ln50_fu_112_p2;
reg   [0:0] icmp_ln50_reg_187;
reg  signed [31:0] tmp_V_361_reg_191;
reg  signed [31:0] tmp_V_362_reg_198;
reg  signed [31:0] tmp_V_365_reg_204;
...
wire   [31:0] add_ln77_fu_136_p2;
reg   [31:0] add_ln77_reg_237;
wire    ap_CS_fsm_state12;
wire   [0:0] icmp_ln74_fu_141_p2;
wire   [31:0] i_12_fu_146_p2;
...
wire   [31:0] add_ln61_fu_166_p2;
reg   [31:0] add_ln61_reg_267;
wire    ap_CS_fsm_state19;
wire   [0:0] icmp_ln58_fu_171_p2;
wire   [31:0] i_fu_176_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((out_stream_V_last_1_state == 2'd1) | (out_stream_V_data_V_1_state == 2'd1) | ((out_stream_V_data_V_1_state == 2'd3) & (out_stream_TREADY == 1'b0)) | ((out_stream_V_last_1_state == 2'd3) & (out_stream_TREADY == 1'b0))) & (1'b1 == ap_CS_fsm_state16))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((out_stream_V_last_1_state == 2'd1) & (out_stream_TREADY == 1'b0)) | ((out_stream_V_last_1_state == 2'd3) & (out_stream_TREADY == 1'b0) & (out_stream_V_last_1_vld_in == 1'b1)))) begin
            out_stream_V_last_1_state <= 2'd1;
        end else if (((~((out_stream_V_last_1_vld_in == 1'b0) & (out_stream_V_last_1_ack_out == 1'b1)) & ~((out_stream_TREADY == 1'b0) & (out_stream_V_last_1_vld_in == 1'b1)) & (out_stream_V_last_1_state == 2'd3)) | ((out_stream_V_last_1_state == 2'd1) & (out_stream_V_last_1_ack_out == 1'b1)) | ((out_stream_V_last_1_state == 2'd2) & (out_stream_V_last_1_vld_in == 1'b1)))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln74_fu_141_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln58_fu_171_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln50_reg_187 == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln50_reg_187 == 1'd1) & (out_stream_V_data_V_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
...
always @ (posedge ap_clk) begin
    if (((~((out_stream_V_data_V_1_ack_in == 1'b0) | (in_stream_V_V_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln74_reg_242 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((icmp_ln58_reg_272 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | (~((out_stream_V_data_V_1_ack_in == 1'b0) | (in_stream_V_V_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln74_fu_141_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_1_reg_251 <= tmp_last_1_fu_152_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln58_fu_171_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_last_reg_281 <= tmp_last_fu_182_p2;
    end
end

always @ (*) begin
    if ((icmp_ln74_fu_141_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((icmp_ln58_fu_171_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((~((out_stream_V_last_1_state == 2'd1) | (out_stream_V_data_V_1_state == 2'd1) | ((out_stream_V_data_V_1_state == 2'd3) & (out_stream_TREADY == 1'b0)) | ((out_stream_V_last_1_state == 2'd3) & (out_stream_TREADY == 1'b0))) & (1'b1 == ap_CS_fsm_state16))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln74_reg_242 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((icmp_ln58_reg_272 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state6) | (1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)) | ((icmp_ln74_reg_242_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln74_reg_242 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((icmp_ln58_reg_272_pp1_iter1_reg == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((icmp_ln58_reg_272 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    if (((icmp_ln58_reg_272 == 1'd0) & (1'b0 == ap_block_pp1_stage0_01001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        out_stream_V_last_1_data_in = tmp_last_reg_281;
    end else if (((icmp_ln74_reg_242 == 1'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state9 : begin
            ...
            end else if (((icmp_ln50_reg_187 == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln74_fu_141_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln74_fu_141_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if ((~((icmp_ln58_fu_171_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if ((((icmp_ln58_fu_171_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter1 == 1'b0) & (ap_enable_reg_pp1_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_state16;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end
...
assign add_ln61_fu_166_p2 = ($signed(OFM_bound_reg_261) + $signed(32'd4294967295));

assign add_ln77_fu_136_p2 = ($signed(KER_bound_reg_231) + $signed(32'd4294967295));
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln74_reg_242 == 1'd0) & (in_stream_V_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state15_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state14_io) | ((icmp_ln74_reg_242 == 1'd0) & (in_stream_V_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state15_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state14_io) | ((icmp_ln74_reg_242 == 1'd0) & (in_stream_V_V_empty_n == 1'b0)))));
end

assign ap_block_pp1_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp1_stage0_01001 = ((icmp_ln58_reg_272 == 1'd0) & (in_stream_V_V_empty_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((1'b1 == ap_block_state22_io) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & ((1'b1 == ap_block_state21_io) | ((icmp_ln58_reg_272 == 1'd0) & (in_stream_V_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((1'b1 == ap_block_state22_io) & (ap_enable_reg_pp1_iter2 == 1'b1)) | ((ap_enable_reg_pp1_iter1 == 1'b1) & ((1'b1 == ap_block_state21_io) | ((icmp_ln58_reg_272 == 1'd0) & (in_stream_V_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state14_io = ((icmp_ln74_reg_242 == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state14_pp0_stage0_iter1 = ((icmp_ln74_reg_242 == 1'd0) & (in_stream_V_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state15_io = ((icmp_ln74_reg_242_pp0_iter1_reg == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b0));
end

assign ap_block_state15_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state16 = ((out_stream_V_last_1_state == 2'd1) | (out_stream_V_data_V_1_state == 2'd1) | ((out_stream_V_data_V_1_state == 2'd3) & (out_stream_TREADY == 1'b0)) | ((out_stream_V_last_1_state == 2'd3) & (out_stream_TREADY == 1'b0)));
end

assign ap_block_state20_pp1_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state21_io = ((icmp_ln58_reg_272 == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b0));
end

always @ (*) begin
    ap_block_state21_pp1_stage0_iter1 = ((icmp_ln58_reg_272 == 1'd0) & (in_stream_V_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state22_io = ((icmp_ln58_reg_272_pp1_iter1_reg == 1'd0) & (out_stream_V_data_V_1_ack_in == 1'b0));
end
...
assign i_12_fu_146_p2 = (i1_0_reg_80 + 32'd1);

assign i_fu_176_p2 = (i_0_reg_91 + 32'd1);

assign icmp_ln50_fu_112_p2 = ((in_stream_V_V_dout == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln58_fu_171_p2 = ((i_0_reg_91 == OFM_bound_reg_261) ? 1'b1 : 1'b0);

assign icmp_ln74_fu_141_p2 = ((i1_0_reg_80 == KER_bound_reg_231) ? 1'b1 : 1'b0);
...
assign tmp_last_1_fu_152_p2 = ((i1_0_reg_80 == add_ln77_reg_237) ? 1'b1 : 1'b0);

assign tmp_last_fu_182_p2 = ((i_0_reg_91 == add_ln61_reg_267) ? 1'b1 : 1'b0);
